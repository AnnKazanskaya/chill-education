...
.elc-hv-cat{position:absolute;top:-22px;left:50%;transform:translateX(-50%);width:106%;max-width:430px;z-index:2;animation:elc-float-c 5.4s ease-in-out infinite}
...
@keyframes elc-float-c{0%,100%{transform:translateX(-50%) translateY(0)}50%{transform:translateX(-50%) translateY(-12px)}}
@media (max-width:760px){
  .elc-hero{grid-template-columns:1fr}
  .elc-hero-visual{min-height:0;height:190px;order:-1;margin-bottom:4px}
  .elc-hv-cat{max-width:230px;width:auto;height:112%}
          ...
          {phase==="intro" && (
            <div className="elc-q elc-hero">
              ...
              <div className="elc-hero-visual" aria-hidden="true">
                <img className="elc-hv-cat" src="img/cat-test.jpg?v=2" alt="" />
              </div>
            </div>
          )}
